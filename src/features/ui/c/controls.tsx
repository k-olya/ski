...
<div>
        ...
        <TouchControl toggle kbKey="ArrowDown" opposite="ArrowUp" className="bottom-8 left-10 p-2">
        ...
        <TouchControl toggle kbKey="ArrowUp" opposite="ArrowDown" className="bottom-8 right-10 p-2">
