...
export const Attributions = () => {
  ...
  return (
    <div className="fixed top-0 w-full h-full p-4 flex justify-center items-center">
      <div
        className={c(
          "w-full h-full rounded-lg bg-opacity-75 bg-black text-white px-3 py-5 flex flex-col justify-start items-center"
        )}
      >
        ...
        <OverlayScrollbarsComponent className="w-full h-full mt-2">
          <div className="flex flex-col justify-start items-center h-full px-3">
