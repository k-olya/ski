...
export const Scene = () => {
  ...
  const { gameLoopActive, playerX, Xvelocity, velocity, steering, boost } = useSelector((s) => s.game);
  ...
  return (
    <>
      ...
      <group
        position={[playerX, lerp(0, 0.75, extraPosition) + boost * 0.1 - 0.1, 0]}
        rotation={[
          0,
      ...
      >
        ...
        <Debris position={[-6.5, 1.35, 2]} />
        <Debris position={[-9.5, 3.15, 2]} />
        <group rotation={[-SLOPE_ANGLE, 0, lerp(-BORDER_ANGLE, BORDER_ANGLE, extraRotation)]} position={[-playerX, lerp(0, 0.2, extraPosition), -lerp(0, 0.2, extraPosition)]} scale={[0.5, 0.5, 0.5]}>
          <Ski position={[-0.15, -0.31, 0.5 + steering * 0.2]} rotation={[0, 2 * Math.atan(clamp(steering * 2, -1, 1) / velocity), 0]} />
          <Ski position={[0.15, -0.31, 0.5 - steering * 0.2]} rotation={[0, 2 * Math.atan(clamp(steering * 2, -1, 1) / velocity), 0]}/>
        </group>
